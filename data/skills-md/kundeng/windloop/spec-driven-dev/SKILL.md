...
version: 1.1.0
description: "DEPRECATED embedded copy of the older `spec-driven-dev` skill in the windloop framework repo. Use the maintained standalone repo `kundeng/spec-driven-dev-skill` instead. Trigger only to redirect older installs or framework copies to the maintained skill."
---
