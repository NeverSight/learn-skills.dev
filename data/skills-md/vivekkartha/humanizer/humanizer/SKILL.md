...
**Watch for:** experts argue, observers have cited, industry reports, some critics, several publications; cited, featured, or profiled in [a list of outlets], trade publications, independent coverage; active social media presence, over N followers; a citation, publication, university, or institution named in the sentence as a badge of authority
**Problem:** A name or an unnamed authority stands in for what was said. Unnamed experts prop up a claim; a list of prestige outlets props up a person. In essays and blog posts, a prestige name in the sentence can stop the reader even when the source is real. When the source text names the real source and what it said, use that. Otherwise cut the unsupported claim or the list. Never invent a source. A missing citation alone is not a tell; most writing is unsourced.
...
**Before (prestige in the sentence):**
...
In essays and blog posts, state the claim and move the source to a short references section. A source in references is kept, not removed. Do not invent a URL, title, or finding. Keep existing link targets. Keep the source in the sentence when the format requires a citation, or when the reader needs it there to judge a disputed fact.
