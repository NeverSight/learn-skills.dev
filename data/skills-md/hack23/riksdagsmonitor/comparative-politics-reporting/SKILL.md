---
name: comparative-politics-reporting
description: International political context, cross-country analysis, global political trends for contextualizing Swedish developments
license: Apache-2.0
---
...
1. **Contextualize** - Swedish politics doesn't occur in vacuum
2. **Learn from Others** - International experiences offer lessons
3. **Avoid Cherry-Picking** - Present balanced comparative evidence
4. **Cultural Sensitivity** - Respect different political traditions
5. **Evidence-Based** - Use credible cross-national data
...
- [V-Dem Institute (Varieties of Democracy)](https://www.v-dem.net/)
- [OECD Country Comparisons](https://www.oecd.org/)
...
- [Comparative Political Data Sets](https://www.cpds-data.org/)
