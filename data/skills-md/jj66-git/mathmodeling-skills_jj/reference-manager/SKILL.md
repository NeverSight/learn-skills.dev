...
- `planning/literature/source_quality_matrix.md` and `method_evidence_matrix.md` from `deep-research`, if available.
- `paper/planning/claim_evidence_map.md` from `academic-paper`, if available.
