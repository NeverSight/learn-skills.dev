---
name: academic-paper
description: "Use when a mathematical modeling project needs whole-paper architecture, claim-evidence mapping, abstract writing, scoped revision, citation checking, writing-quality review, or final formatting after validated modeling artifacts exist."
metadata:
  version: "3.2.0"
...
`references/math-modeling-adaptation.md` before selecting a mode or dispatching any agent. Its
contest-specific authority overrides conflicting journal defaults below. `workflow-orchestrator`,
the modeling gates, human decisions, solution packages, and frozen numbers remain authoritative.
