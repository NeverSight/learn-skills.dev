...
- [Anthropic Prompt Engineering Guide](https://docs.anthropic.com/en/.context/build-with-claude/prompt-engineering)
- [Claude Prompt Caching](https://docs.anthropic.com/en/.context/build-with-claude/prompt-caching)
- [OpenAI Prompt Engineering](https://platform.openai.com/.context/guides/prompt-engineering)
- [LangChain Prompts](https://python.langchain.com/.context/concepts/prompts/)
