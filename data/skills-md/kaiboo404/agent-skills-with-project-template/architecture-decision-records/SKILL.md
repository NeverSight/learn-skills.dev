...
- [PostgreSQL JSON Documentation](https://www.postgresql.org/.context/current/datatype-json.html)
- [PostgreSQL Full Text Search](https://www.postgresql.org/.context/current/textsearch.html)
- Internal: Performance benchmarks in `/.context/benchmarks/database-comparison.md`
```
...
adr generate toc > .context/adr/README.md
